...
interface OrderSummaryData {
  ...
  topSalesCategories: Array<{ _id: string; totalSales: number }>
  topSalesProducts: Array<{ _id: string; name: string; image: string; totalSales: number }>
      ...
      <div className='space-y-4'>
        ...
        <div className='grid gap-4 md:grid-cols-2'>
          ...
          <Card>
            ...
            <CardContent>
              <TableChart 
                data={data.topSalesProducts.map(product => ({
                  label: product.name,
